"""Scoring engine and dashboard data layer.

Everything the Streamlit app needs, in one file: the Altman feature engine, the four
digital signals, the combined score, the stress test, and the narrative helpers, plus
the per-company functions the UI calls.
"""
...
_ROSTER: dict[str, tuple[ScreenerFinancials, Optional[ScreenerFinancials]]] = {
    ...
    "Ola Electric": (OLA_2026, None),
    "Vodafone Idea": (VODAFONE_IDEA_2026, None),
    "Vedanta": (VEDANTA_2026, None),
    "Paytm": (PAYTM_2026, None),
    "TCS": (TCS_2026, None),
}
...
def _economics_artifact() -> dict:
    ...
    p = Path(__file__).resolve().parent / "models" / "review_economics.json"

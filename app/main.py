...
# ==================================================================== Live Lookup
# The scoreable NSE universe lives in `src/nse_universe.py` -- shared with the snapshot
# builder so the baked financials never drift from the list the UI offers.
